<?php get_header();?>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">The only 1 creative. Flower. owner of @onecreativex and @poeticflowerx
                        ✨🌸. Poet
                    </p>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <img class="about-img" src="./assets/273481140_505752304311033_3960426121381137167_n.jpg">
                    <h2 class="text-white mt-2">About Me</h2>
                    <hr class="divider divider-light" />
                    <p class="text-white-75 mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt
                        suscipit culpa, ratione rerum deleniti consequatur tempore sequi fugiat porro at ducimus cumque,
                        exercitationem soluta ad. Nisi dolorem maiores voluptatem quis?</p>
    ...
    <section class="page-section" id="blog">
        <div class="container text-center px-4 px-lg-5">
            <img class="blog-img mx-auto" src="./assets/273429983_639680010577185_6237326259307283658_n.jpg">
            ...
            <div class="row gx-4 gx-lg-5">
                ...
                <hr class="my-4">
                <div class="post-preview row align-items-center">
                    <img class="post-img col-sm" src="./assets/273197821_245091231128508_1275305227806123057_n.jpg">
                    <div class="post-text col-sm ">
                        <a href="post.html">
                    ...
                    <hr class="my-4">
                    <div class="post-preview row align-items-center">
                        <img class="post-img col-sm"
                            src="./assets/273658926_1261297181027667_2324364311045832437_n.jpg">
                        <div class="post-text col-sm ">
                            <a href="post.html">
                                <h2 class="post-title">Man must explore, and this is exploration at its greatest</h2>
