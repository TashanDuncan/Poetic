    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 text-center">
                <img class="about-img"
                    src="<?php echo get_theme_file_uri();?>/images/273481140_505752304311033_3960426121381137167_n.jpg">
...
<section class="page-section" id="blog">
    <div class="container text-center px-4 px-lg-5">
        <img class="blog-img mx-auto mb-4"
            src="<?php echo get_theme_file_uri();?>/images/273429983_639680010577185_6237326259307283658_n.jpg">
